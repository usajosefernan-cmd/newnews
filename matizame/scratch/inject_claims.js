...
const db = getDb();
console.log('Inyectando claims reales de prueba en scraped_items...');
...
// Inyectar bulo de okupas con imagen de Unsplash
insert.run(
...
// Inyectar bulo fiscal de jubilados con imagen de Unsplash
insert.run(
...
console.log('✅ Claims inyectados con éxito.');
db.close();
