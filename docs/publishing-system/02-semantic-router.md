...
El Enrutador Semántico es el módulo de inteligencia artificial encargado de categorizar dinámicamente un claim detectado en redes sociales. Su objetivo es clasificar el hecho dentro de uno o varios expedientes temáticos vivos en NewNews.
