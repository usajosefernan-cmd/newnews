...
```text
/scripts/newnews-engine/run-daily.js
/scripts/newnews-engine/run-hourly.js
/scripts/newnews-engine/run-manual-item.js
/scripts/newnews-engine/lib/logger.js
/scripts/newnews-engine/lib/safe-json.js
/scripts/newnews-engine/lib/phase-runner.js
/scripts/newnews-engine/lib/contracts.js
```
