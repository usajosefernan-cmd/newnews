...
Es **NewNews Live Agentic**, en tiempo real: escucha, razona, escribe paneles y puede hablar solo cuando toca.
...
# NewNews Live Agentic — Plan definitivo
...
```text
“NewNews, ¿esto es cierto?”
“NewNews, ¿qué le pregunto?”
“NewNews, ¿hay trampa aquí?”
“NewNews, explícame esto fácil.”
“NewNews, guarda este claim.”
```
...
```text
┌──────────────────────────────────────────────────────┐
│ NewNews Live | Modo: Directo / Reunión / Banco        │
├───────────────┬──────────────────────┬───────────────┤
...
Wake Word Detector
Detecta “NewNews...” para responder.
...
Interactivo
Solo responde si dices “NewNews...”.
```
...
## 13. Integración con NewNews normal
...
```text
IMPLEMENTAR NEWNEWS LIVE AGENTIC EN WEB

Objetivo:
Crear un módulo web realtime dentro de NewNews para analizar directos, vídeos, reuniones y conversaciones importantes.
...
2. Wake mode: solo responde si el usuario dice “NewNews” o una frase configurada.
...
- Permitir enviar claims a cola NewNews.
...
3. Vídeo embebido.
4. Realtime provider.
5. Integración con cola NewNews.
